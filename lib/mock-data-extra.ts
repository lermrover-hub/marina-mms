...
export const mockStaff = [
  ...
  { id: "staff-004", name: "Apinya Rattana",      role: "OPERATION_STAFF", department: "Marina Ops",   phone: "+66 84 444 5566", email: "apinya@marinamms.com",    status: "ACTIVE", hireDate: "2022-02-01", specialties: ["Launch/Haul-out","Berth Assignment"], activeJobs: 0, completedThisMonth: 12 },
...
export const mockRampBookings = [
  ...
  { id: "rb-002", bookingRef: "RB-2026-040", customerId: "cust-002", customerName: "Samui Blue Horizon Charter Co.",  boatId: "boat-003", boatName: "Blue Dream",     boatDraftFt: 3.9, operationType: "HAUL_OUT", status: "COMPLETED", scheduledDate: "2026-05-18", scheduledTime: "08:00", assignedStaff: ["Apinya Rattana"],                   trailerType: "company", safeWindow: "07:30-11:00", notes: "Post-repair haul-out" },
