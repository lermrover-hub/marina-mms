...
const paintServicesPricing = [
  // Paint Service Labor Rates (L5.1)
  {
    code: "P01",
...
export async function seedPaintServicesPricing() {
  console.log("🎨 Seeding Paint Services pricing...")

  for (const pricing of paintServicesPricing) {
  ...
  console.log("✨ Paint Services pricing seeded!")
}
